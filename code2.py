    ...
    if request.method == 'GET':
        ...
        if 'text' in w:
            if request.form['text'] is not None:
                mes = Message(content=request.form['text'], photo=None, user_name='Пользователь 2',
            ...
            mes = Message(content='', photo=f'img/{name}', user_name='Пользователь 2',
                          user_to_name='Пользователь 3')
            db_sess.add(mes)
            db_sess.commit()
        message = list(db_sess.query(Message).filter((Message.user_name.in_(['Пользователь 2', 'Пользователь 3'])),
...
def index3():
    if request.method == 'GET':
        ...
        if 'text' in w:
            if request.form['text'] is not None:
                mes = Message(content=request.form['text'], photo=None, user_name='Пользователь 3',
